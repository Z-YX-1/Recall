...
- **最近一次测试结果**（2026-09-25）：`pytest` **216 passed**；`ruff` 零告警；`mypy` strict **44 文件**零错误；R-45 验收脚本 **15/15 全绿**（鉴权关闭态）
...
- **本文件版本**：v0.16.0（2026-09-25 **R-42 阶段 1 完成**：证据门槛实现为默认关闭的配置项，A/B 证明零召回代价 + 笔记外 21/21 全拒。**当前待项目工程师：R-40/R-38 验收 + R-42 是否开启门槛 + R-46 处置 + 实现细节背书**）
